# XMC MCU: FreeRTOS Blinky

This code example demonstrates the blinking LED functionality implemented by FreeRTOS tasks running on the XMC&trade; MCU devices.
...
This example toggles an LED using FreeRTOS tasks. The “**pin 1.0**” personality is used here to configure the LED pin in **Device Configurator.** The toggle period is defined by USER_LED_TOGGLE_PERIOD_MS.
...
| FreeRTOS  | [FreeRTOS](https://github.com/cypresssemiconductorco/freertos) on GitHub |
| **Tools**                                                    |                                                              |
...
Document Title: *CE231920* - *XMC MCU: FreeRTOS Blinky*
